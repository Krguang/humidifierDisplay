...
TARGETNAME := humidifierDisplay.elf
...
$(BINARYDIR)/display.o : Src/display.c $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)
...
$(BINARYDIR)/white12864.o : Src/white12864.c $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)
